...
public class WeaponsForgeGUIButtonMessage {
	...
	public static void handler(WeaponsForgeGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		FineTunedWeaponryMod.addNetworkMessage(WeaponsForgeGUIButtonMessage.class, WeaponsForgeGUIButtonMessage::buffer, WeaponsForgeGUIButtonMessage::new, WeaponsForgeGUIButtonMessage::handler);
	}
}
