...
public class RemoveGemProcedure {
	public static void execute(Entity entity) {
		...
		for (int index0 = 0; index0 < 6; index0++) {
			if (!(((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).getOrCreateTag().getString(("ft_slot" + count)))
					.equals(""))) {
				if (new Object() {
