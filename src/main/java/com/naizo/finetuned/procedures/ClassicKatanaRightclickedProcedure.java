...
public class ClassicKatanaRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (entity.onGround()) {
			entity.setDeltaMovement(new Vec3((entity.getDeltaMovement().x() + entity.getLookAngle().x * JaumlConfigLib.getNumberValue("finetunned/weapons", "katana_config", "dash_power")),
					(entity.getDeltaMovement().y() + entity.getLookAngle().y * JaumlConfigLib.getNumberValue("finetunned/weapons", "katana_config", "dash_power")),
					(entity.getDeltaMovement().z() + entity.getLookAngle().z * JaumlConfigLib.getNumberValue("finetunned/weapons", "katana_config", "dash_power"))));
			...
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(itemstack.getItem(), (int) JaumlConfigLib.getNumberValue("finetunned/weapons", "katana_config", "dash_cooldown"));
			particleAmount = 30;
			particleRadius = 4;
