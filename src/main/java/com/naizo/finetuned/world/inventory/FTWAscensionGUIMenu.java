...
import com.naizo.finetuned.network.FTWAscensionGUISlotMessage;
import com.naizo.finetuned.init.FineTunedWeaponryModMenus;
import com.naizo.finetuned.FineTunedWeaponryMod;

public class FTWAscensionGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FTWAscensionGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FineTunedWeaponryModMenus.FTW_ASCENSION_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			FineTunedWeaponryMod.PACKET_HANDLER.sendToServer(new FTWAscensionGUISlotMessage(slotid, x, y, z, ctype, meta));
			FTWAscensionGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
