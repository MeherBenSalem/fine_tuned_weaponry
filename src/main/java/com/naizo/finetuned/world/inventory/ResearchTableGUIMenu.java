...
public class ResearchTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ResearchTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 38, 21) {
			private final int slot = 0;
			private int x = ResearchTableGUIMenu.this.x;
			private int y = ResearchTableGUIMenu.this.y;
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 38, 46) {
			private final int slot = 1;
			private int x = ResearchTableGUIMenu.this.x;
			private int y = ResearchTableGUIMenu.this.y;
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 65, 33) {
			private final int slot = 2;
			private int x = ResearchTableGUIMenu.this.x;
			private int y = ResearchTableGUIMenu.this.y;
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 118, 33) {
