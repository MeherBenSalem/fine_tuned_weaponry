...
public class FineTunedWeaponryMod {
	public static final Logger LOGGER = LogManager.getLogger(FineTunedWeaponryMod.class);
	public static final String MODID = "fine_tuned_weaponry";

	public FineTunedWeaponryMod() {
