...
import com.naizo.finetuned.procedures.HelishSwordRightclickedProcedure;
...
public class HelishSwordItem extends SwordItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		HelishSwordRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
