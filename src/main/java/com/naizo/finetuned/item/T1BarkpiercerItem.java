...
public class T1BarkpiercerItem extends SwordItem {
	public T1BarkpiercerItem() {
		super(new Tier() {
			public int getUses() {
				return 59;
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(FineTunedWeaponryModItems.T_1_BARKPIERCER.get()));
			}
